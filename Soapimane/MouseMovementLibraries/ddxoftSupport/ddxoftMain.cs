    ...
    internal class DdxoftMain
    {
        ...
        public static async Task<bool> DLLLoading()
        {
            try
            {
                ...
                {
                    MessageBox.Show("The ddxoft Virtual Input Driver requires Soapimane to be run as an administrator, please close Soapimane and run it as administrator to use this movement method.", "Soapimane");
                    return false;
                }
                ...
                {
                    MessageBox.Show("The ddxoft virtual input driver is not compatible with your PC, please try a different Mouse Movement Method.", "Soapimane");
                    return false;
                }
